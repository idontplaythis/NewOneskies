local Prey = nil
local Plr  = nil
local OldSilentAimPart = getgenv().Memelouse3150.Silent.AirPart
    ...
    for _ ,v in pairs(Players:GetPlayers()) do
    	if getgenv().Memelouse3150.Silent.WallCheck then
    		if (v.Character and v ~= Client and v.Character:FindFirstChild("HumanoidRootPart")) then
    			local Position, OnScreen = Camera:WorldToScreenPoint(
        			    -- Both R6 and r15
        			    v.Character:FindFirstChild("HumanoidRootPart").Position or 
        			    v.Character:FindFirstChild("Head").Position or 
        			    -- R15
        			    v.Character:FindFirstChild("UpperTorso").Position or 
        			    v.Character:FindFirstChild("LowerTorso").Position or 
        			    v.Character:FindFirstChild("LeftFoot").Position or 
        			    v.Character:FindFirstChild("LeftLowerLeg").Position or 
        			    v.Character:FindFirstChild("LeftUpperLeg").Position or 
        			    v.Character:FindFirstChild("RightFoot").Position or 
        			    v.Character:FindFirstChild("RightLowerLeg").Position or 
        			    v.Character:FindFirstChild("RightUpperLeg").Position or 
        			    v.Character:FindFirstChild("LeftHand").Position or 
        			    v.Character:FindFirstChild("LeftUpperArm").Position or 
        			    v.Character:FindFirstChild("LeftLowerArm").Position or 
        			    v.Character:FindFirstChild("RightHand").Position or 
        			    v.Character:FindFirstChild("RightLowerArm").Position or 
        			    v.Character:FindFirstChild("RightUpperArm").Position or 
        			    -- R6
        			    v.Character:FindFirstChild("Torso").Position or 
        			    v.Character:FindFirstChild("LeftArm").Position or 
        			    v.Character:FindFirstChild("RightArm").Position or 
        			    v.Character:FindFirstChild("LeftLeg").Position or 
        			    v.Character:FindFirstChild("RightLeg").Position
    			    )
    			local Distance = (Vector2.new(Position.X, Position.Y) - Vector2.new(Mouse.X, Mouse.Y)).Magnitude
                
    			if (Circle.Radius > Distance and Distance < Closest and OnScreen and WallCheck(v.Character[getgenv().Memelouse3150.Tracer.Part].Position, {Client, v.Character})) then
    				Closest = Distance
    				Target = v
    			end
    		end
...
RS.Heartbeat:Connect(function()
	if getgenv().Memelouse3150.Silent.Enabled then
	    if Prey and Prey.Character and Prey.Character:WaitForChild(getgenv().Memelouse3150.Silent.Part) then
            ...
            if getgenv().Memelouse3150.Silent.UseAirPart == true and Prey.Character:FindFirstChild("Humanoid") then
                if Prey.Character.Humanoid.FloorMaterial == Enum.Material.Air and Prey.Character.Humanoid.Jump == true then
                    getgenv().Memelouse3150.Silent.Part = getgenv().Memelouse3150.Silent.AirPart
                else
                    getgenv().Memelouse3150.Silent.Part = OldSilentAimPart
                end
            end
	    end
	end
...
RS.RenderStepped:Connect(function()
	if getgenv().Memelouse3150.Silent.Enabled then
		...
		if getgenv().Memelouse3150.Silent.AutoPrediction then
            local ping = Client:GetNetworkPing() * 2000
            if ping > 120 then
                getgenv().Memelouse3150.Silent.PredictionVelocity = 0.15465
            elseif ping > 110 then
                getgenv().Memelouse3150.Silent.PredictionVelocity = 0.14965
            elseif ping > 100 then
                getgenv().Memelouse3150.Silent.PredictionVelocity = 0.1455
            elseif ping > 90 then
                getgenv().Memelouse3150.Silent.PredictionVelocity = 0.141
            elseif ping > 80 then
                getgenv().Memelouse3150.Silent.PredictionVelocity = 0.138
            elseif ping > 70 then
                getgenv().Memelouse3150.Silent.PredictionVelocity = 0.1345
            elseif ping > 60 then
                getgenv().Memelouse3150.Silent.PredictionVelocity = 0.132
            elseif ping > 50 then
                getgenv().Memelouse3150.Silent.PredictionVelocity = 0.129668
            elseif ping > 40 then
                getgenv().Memelouse3150.Silent.PredictionVelocity = 0.12405
        end
	end
    if getgenv().Memelouse3150.Tracer.Enabled == true then
